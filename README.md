...
kms-interface-rom
=================
JSON Remote Object Model for the Kurento media server

The kms-interface-rom project contains the definition of
the Remote Object Model that is used for communication
between the Kurento Media Server and Kurento Media Framework,
Android or Web SDKs.
...
[GitHub Repository]: https://github.com/kurento/kms-interface-rom
